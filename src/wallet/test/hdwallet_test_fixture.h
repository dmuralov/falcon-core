...
#ifndef FALCON_WALLET_TEST_HDWALLET_TEST_FIXTURE_H
#define FALCON_WALLET_TEST_HDWALLET_TEST_FIXTURE_H
...
/** Testing setup and teardown for falcon wallet.
 */
...
#endif // FALCON_WALLET_TEST_HDWALLET_TEST_FIXTURE_H
