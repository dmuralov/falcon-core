...
void SQLiteDatabase::Open()
{
    ...
    if (ret != SQLITE_OK) {
        throw std::runtime_error("SQLiteDatabase: Unable to obtain an exclusive lock on the database, is it being used by another falcond?\n");
    }
...
bool SQLiteBatch::ReadKey(CDataStream&& key, CDataStream& value, int nFlags)
{
