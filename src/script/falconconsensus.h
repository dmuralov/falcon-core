...
#ifndef FALCON_SCRIPT_FALCONCONSENSUS_H
#define FALCON_SCRIPT_FALCONCONSENSUS_H
...
#include <config/bitcoin-config.h>
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBFALCONCONSENSUS)
...
#endif // FALCON_SCRIPT_FALCONCONSENSUS_H
