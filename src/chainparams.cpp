...
public:
    CMainParams() {
        ...
        std::cout << "hsh -> " << to_string(consensus.hashGenesisBlock) << std::endl;
        std::cout << "hsh -> " << to_string(genesis.hashMerkleRoot) << std::endl;
        std::cout << "hsh -> " << to_string(genesis.hashWitnessMerkleRoot) << std::endl;
