...
public:
    CMainParams() {
        ...
        std::cout << "hsh -> " << (int64_t)consensus.hashGenesisBlock << std::endl;
        std::cout << "hsh -> " << (int64_t)genesis.hashMerkleRoot << std::endl;
        std::cout << "hsh -> " << (int64_t)genesis.hashWitnessMerkleRoot << std::endl;
