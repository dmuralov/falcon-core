...
public:
    CMainParams() {
        ...
        std::cout << "hsh -> " << string(consensus.hashGenesisBlock) << std::endl;
        std::cout << "hsh -> " << string(genesis.hashMerkleRoot) << std::endl;
        std::cout << "hsh -> " << string(genesis.hashWitnessMerkleRoot) << std::endl;
